...
<form action="{{ route('mill_form.update', $millform->id) }}" method="POST"><br/>
    @csrf
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                    <div class="form-group mb-3">
                        <?=Form::label('mill_form_year', 'Year:');?>
                        <?=Form::selectRange('mill_form_year', 1990, 2099, null, array('class'=>'a'));?>
                    </div>
                ...
                <div class="form-group mb-3">
                    ...
                    {{-- <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="mill_unit_name" class="form-control"
                                placeholder="Enter the operating units' name..." value="<?=$millform->mill_unit_name?>">
                        </div>
                    </div> --}}
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="mill_commission_info" class="form-control" placeholder="1971..." value="<?=$millform->mill_commission_info?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            ...
                            <input  type="number" step=any name="mill_throughput" class="form-control"
                                placeholder="60mt/hours..." value="<?=$millform->mill_throughput?>" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="int" name="mill_staff_exe" class="form-control" placeholder="E.g: 26" value="<?=$millform->mill_staff_exe?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            <strong>Staff & Executive Dependants:</strong>
                            <input type="int" name="mill_staff_exed" class="form-control" placeholder="E.g: 55" value="<?=$millform->mill_staff_exed?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            <strong>Workers:</strong>
                            <input type="int" name="mill_workers" class="form-control" placeholder="E.g: 102" value="<?=$millform->mill_workers?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            <strong>Workers Dependants:</strong>
                            <input type="int" name="mill_worker_dep" class="form-control" placeholder="E.g: 102" value="<?=$millform->mill_worker_dep?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            <strong>Total Housing (All):</strong>
                            <input type="int" name="mill_total_housing" class="form-control" placeholder="E.g: 100" value="<?=$millform->mill_total_housing?>">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            <table class="table table-bordered text-center" id="table_mill_rainfall">
                                ...
                                <tr>
                                    <td><input class="form-control" , name="mill_Jan" value="<?=$millform->mill_Jan?>"></td>
                                    <td><input class="form-control" , name="mill_Feb" value="<?=$millform->mill_Feb?>"></td>
                                    <td><input class="form-control" , name="mill_Mar" value="<?=$millform->mill_Mar?>"></td>
                                    <td><input class="form-control" , name="mill_Apr" value="<?=$millform->mill_Apr?>"></td>
                                    <td><input class="form-control" , name="mill_May" value="<?=$millform->mill_May?>"></td>
                                    <td><input class="form-control" , name="mill_Jun" value="<?=$millform->mill_Jun?>"></td>
                                    <td><input class="form-control" , name="mill_Jul" value="<?=$millform->mill_Jul?>"></td>
                                    <td><input class="form-control" , name="mill_Aug" value="<?=$millform->mill_Aug?>"></td>
                                    <td><input class="form-control" , name="mill_Sep" value="<?=$millform->mill_Sep?>"></td>
                                    <td><input class="form-control" , name="mill_Oct" value="<?=$millform->mill_Oct?>"></td>
                                    <td><input class="form-control" , name="mill_Nov" value="<?=$millform->mill_Nov?>"></td>
                                    <td><input class="form-control" , name="mill_Dec" value="<?=$millform->mill_Dec?>"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" rows="4" name="mill_general_remark"
                                placeholder="Other remarks..." value="<?=$millform->mill_general_remark?>"></textarea>
                        </div>
                    </div>
                    <br>
                    <hr>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mb-4">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <input type="checkbox" name="mill_domestic_af_other_parameter_value"value="<?=$millform->mill_domestic_af_other_parameter_value?>">
                                        </div>
                                    </div>
                                    <input type="text" class="form-control"
                                        name="mill_domestic_af_other_parameter_name"value="<?=$millform->mill_domestic_af_other_parameter_name?>">
                                </div>
                                <strong>Quality Monitoring Frequency: </strong>
                                <textarea class="form-control" rows="2" name="mill_domestic_wqm_af_qmf"
                                    placeholder="Quality Monitoring Frequency..."value="<?=$millform->mill_domestic_wqm_af_qmf?>"></textarea>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <textarea class="form-control" rows="2" name="mill_domestic_wwm_ss"
                        placeholder="Eg: Weekly house inspection,..."value="<?=$millform->mill_domestic_wwm_ss?>"></textarea><br />
                    <h4>Drainage</h4>
                    <textarea class="form-control" rows="2" name="mill_domestic_wwm_d"
                        placeholder="Eg: Weekly house inspection,..."value="<?=$millform->mill_domestic_wwm_d?>"></textarea>
                    <br>
                    <hr>
                    <br>
                    ...
                    <textarea class="form-control" rows="2" name="mill_domestic_watlc_list_stake"
                        placeholder="List of stakeholder..."value="<?=$millform->mill_domestic_watlc_list_stake?>"></textarea>
                    ...
                    <textarea class="form-control" rows="2" name="mill_domestic_watlc_feedback_stake"
                        placeholder="Feedback..."value="<?=$millform->mill_domestic_watlc_feedback_stake?>"></textarea>
                    ...
                    <textarea class="form-control" rows="2" name="mill_domestic_watlc_infoplan_stake"
                        placeholder="Plan..."value="<?=$millform->mill_domestic_watlc_infoplan_stake?>"></textarea>
                    <br>
                    <hr>
                    <br>
                    ...
                    <textarea class="form-control" rows="2" name="mill_domestic_erp_dsp"
                        placeholder="Plan..."value="<?=$millform->mill_domestic_erp_dsp?>"></textarea>
                    <strong>Distruption of water supply from Jabatan Air: </strong>
                    <textarea class="form-control" rows="2" name="mill_domestic_erp_dwsja" placeholder="..."value="<?=$millform->mill_domestic_erp_dwsja?>"></textarea>
                    <br>
                    <hr>
                    <br>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        <div class="form-group mb-3">
                            <table class="table table-bordered text-center" id="table_mill_ae">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input class="form-control" name="mill_domestic_ae_np[]"value="<?=$millform->mill_domestic_ae_np?>"></td>
                                        ...
                                        <td><input class="form-control" name="mill_domestic_ae_pic[]"value="<?=$millform->mill_domestic_ae_pic?>"></td>
                                        <td><button type="button" class="btn btn-danger"
                    ...
                    <input class="form-control" name="mill_domestic_map_mill_area"value="<?=$millform->mill_domestic_map_mill_area?>"><br />
                    <strong>Office & Housing Area</strong>
                    <input class="form-control" name="mill_domestic_map_oh_area"value="<?=$millform->mill_domestic_map_oh_area?>"><br />
                    <strong>Water Sources</strong>
                    <input class="form-control" name="mill_domestic_map_ws_area"value="<?=$millform->mill_domestic_map_ws_area?>"><br />
                    <strong>Water Treatment Plant</strong>
                    <input class="form-control" name="mill_domestic_map_wtp_area"value="<?=$millform->mill_domestic_map_wtp_area?>"><br />
                    <strong>Riparian Zone</strong>
                    <input class="form-control" name="mill_domestic_map_rz_area"value="<?=$millform->mill_domestic_map_rz_area?>"><br />
                    <strong>Stakeholder Settlement</strong>
                    <input class="form-control" name="mill_domestic_map_ss_area"value="<?=$millform->mill_domestic_map_ss_area?>"><br />
